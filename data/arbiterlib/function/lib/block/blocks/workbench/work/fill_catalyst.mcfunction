...
execute unless items block ~ ~ ~ container.24 * run item replace block ~ ~ ~ container.24 with knowledge_book[rarity="common",tooltip_display={hide_tooltip:true},item_model="arbiterlib:craft_catalyst_slot_ring",custom_data={arbiterlib:{item:"null"}}]