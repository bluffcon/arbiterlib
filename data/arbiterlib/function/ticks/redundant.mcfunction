...
execute unless score .redundant arbiterlib.timer matches 1..60 run scoreboard players set .redundant arbiterlib.timer 5
...
# for functions that can be ran as often as every 5 seconds and 40 seconds. server admins can override this
