...
\
run return run function arbiterlib:craft/workbench/craft/found {namespace:"arbiterlib",loottable:"bread_pickaxe",rarity:"common",item:"stone_pickaxe",max_stack:1,count:1}
