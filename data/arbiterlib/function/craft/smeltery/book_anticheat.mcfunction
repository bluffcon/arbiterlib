...
execute if score @s arbiterlib.block.active matches 0 run return run item modify block ~ ~ ~ container.6 {function:set_item,item:knowledge_book}
...
item modify block ~ ~ ~ container.6 {function:set_item,item:knowledge_book}
